...
module.exports = (webpackEnv) => {
  ...
  console.log(isEnvDevelopment, isEnvProduction, process.env.NODE_ENV);
  ...
  const getStyleLoaders = (cssOptions, preProcessor) => {
    ...
    if (preProcessor) {
      ...
      const antdCustomizeLessPath = path.resolve(paths.appSrc, 'styles/antd.customize.less');
      if (fs.existsSync(antdCustomizeLessPath)) {
        const antdCustomizeThemeVariables = lessToJs(
          fs.readFileSync(antdCustomizeLessPath, 'utf-8')
        );
